      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-20">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-14">
          ...
          >
            ...
            <p className="text-muted-foreground/70 text-sm max-w-xl mb-6 font-light">
              {profile.tagline}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 justify-center md:justify-start mb-8">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs text-muted-foreground ml-1">5.0 (0 reviews)</span>
              </div>
              <a
                href="/Prakhar_Parashar_CV.docx"
                download
        ...
        >
          <div className="inline-block px-5 py-3 rounded-lg bg-card/60 border border-border/50">
            ...
            <p className="text-xs text-muted-foreground">
              <span className="text-foreground/80">Weekdays:</span> {profile.availability.weekdays}
            </p>
            <p className="text-xs text-muted-foreground">
              <span className="text-foreground/80">Weekends:</span> {profile.availability.weekends}
            </p>
          </div>
        </motion.div>
