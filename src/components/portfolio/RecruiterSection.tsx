        ...
        >
          ...
          <div className="flex items-start gap-2 mb-6 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
            ...
            <p className="text-xs text-emerald-300/80">
              🔒 <strong>Privacy Notice:</strong> Your job description is processed entirely in your browser. No data is stored, sent to any server, or recorded in any way. This tool is completely safe and private.
            </p>
          </div>
          ...
          <div className="flex gap-3 mt-3">
            ...
            {matchResult && (
              <button
                onClick={() => { setMatchResult(null); setJobDesc(""); }}
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {matchResult.matched.length} of {coreCompetencies.length} skills matched
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {matchResult.matched.map((s) => (
                      <span key={s} className="px-2 py-1 rounded text-xs bg-emerald-500/15 text-emerald-300 border border-emerald-500/20">
                        {s}
                      </span>
                    ))}
                  </div>
